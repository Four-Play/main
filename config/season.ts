...
export const SEASON_WEEKS: SeasonWeek[] = [
  { week: 1, name: 'Sunday',       startDate: '2026-04-12', endDate: '2026-04-13', placeholderCount: 8  },
  { week: 2, name: 'Play-In',      startDate: '2026-04-14', endDate: '2026-04-18', placeholderCount: 4  },
  { week: 3, name: 'First Round',  startDate: '2026-04-19', endDate: '2026-04-28', placeholderCount: 8  },
