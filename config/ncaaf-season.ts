...
export const NCAAF_SEASON_WEEKS: SeasonWeek[] = [
  ...
  { week:  2, name: 'WK 2',           startDate: '2026-09-09', endDate: '2026-09-13', placeholderCount: 4 },
  ...
  { week:  5, name: 'WK 5',           startDate: '2026-09-28', endDate: '2026-10-04', placeholderCount: 4 },
  { week:  6, name: 'WK 6',           startDate: '2026-10-05', endDate: '2026-10-11', placeholderCount: 4 },
  { week:  7, name: 'WK 7',           startDate: '2026-10-12', endDate: '2026-10-18', placeholderCount: 4 },
  { week:  8, name: 'WK 8',           startDate: '2026-10-19', endDate: '2026-10-25', placeholderCount: 4 },
  { week:  9, name: 'WK 9',           startDate: '2026-10-26', endDate: '2026-11-01', placeholderCount: 4 },
  { week: 10, name: 'WK 10',          startDate: '2026-11-02', endDate: '2026-11-08', placeholderCount: 4 },
  { week: 11, name: 'WK 11',          startDate: '2026-11-09', endDate: '2026-11-15', placeholderCount: 4 },
  { week: 12, name: 'WK 12',          startDate: '2026-11-16', endDate: '2026-11-22', placeholderCount: 4 },
  { week: 13, name: 'WK 13',          startDate: '2026-11-23', endDate: '2026-11-29', placeholderCount: 4 },
  { week: 14, name: 'WK 14',          startDate: '2026-11-30', endDate: '2026-12-04', placeholderCount: 4 },
  { week: 15, name: 'Conf. Champs',   startDate: '2026-12-05', endDate: '2026-12-07', placeholderCount: 4 },
