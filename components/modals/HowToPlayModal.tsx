...
function MiniPickButton({ team, spreadLabel, adjLabel, selected }: {
  ...
  return (
    <div className={`flex-1 rounded-lg p-2 border ${selected ? 'border-green-500 bg-green-500/10' : 'border-zinc-800'}`}>
      <p className="font-bold text-[12px] text-white uppercase leading-tight">{team}</p>
        ...
        <div className="space-y-7 py-4 overflow-y-auto flex-1 min-h-0 pr-1">
          ...
          <div>
            ...
            <div className="rounded-xl bg-zinc-900 border border-zinc-800 p-3 mb-3">
                  ...
                  return (
                    ...
                    >
                      {filled ? (
                        ...
                        <span className="text-[14px] text-zinc-700 font-black leading-none">+</span>
                      )}
                    </div>
                  )
                })}
              ...
              <div className="mb-1.5">
                <span className="text-[9px] bg-zinc-800 text-zinc-500 px-2 py-0.5 rounded font-mono uppercase">SUN 4:25 PM</span>
              </div>
            ...
            <div className="flex items-center justify-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 mb-3">
              <div className="text-center">
                <p className="text-[9px] text-zinc-600 uppercase tracking-widest mb-0.5">Spread</p>
                <p className="text-2xl font-black font-mono text-red-400">–10</p>
              </div>
              <p className="text-zinc-600 font-black text-xl pb-2">+</p>
              <div className="text-center">
                <p className="text-[9px] text-zinc-600 uppercase tracking-widest mb-0.5">Cushion</p>
                <p className="text-2xl font-black font-mono text-green-400">+13</p>
              </div>
              <p className="text-zinc-600 font-black text-xl pb-2">=</p>
              <div className="text-center">
                <p className="text-[9px] text-zinc-600 uppercase tracking-widest mb-0.5">Your Line</p>
            ...
            <div className="mb-3">
              <div className="flex h-8 rounded-lg overflow-hidden border border-zinc-800">
                <div className="w-[38%] bg-red-500/15 border-r border-red-500/20 flex items-center justify-center">
                  <span className="text-[10px] font-black text-red-400">LOSS</span>
                </div>
                <div className="flex-1 bg-green-500/10 flex items-center justify-center">
                  <span className="text-[10px] font-black text-green-400">WIN</span>
                </div>
              </div>
              <div className="flex mt-1 px-0.5">
                <div className="w-[38%] text-center">
                  <span className="text-[9px] text-zinc-600 font-mono">lose by 3+</span>
                </div>
                <div className="flex-1 text-center">
                  <span className="text-[9px] text-zinc-500 font-mono">lose by ≤2, or win</span>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="rounded-xl bg-zinc-900 border border-zinc-800 overflow-hidden mb-3">
              <div className="px-3 py-2 border-b border-zinc-800 flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">1 Winner</span>
                <span className="text-[10px] font-mono text-zinc-600">4 × 50 = 200 pt pot</span>
              </div>
                ...
                <div className="flex gap-1.5">
                  {[['You', '–50'], ['Player B', '–50'], ['Player C', '–50'], ['Player D', '–50']].map(([n, p]) => (
                    <div key={n} className="flex-1 rounded-lg bg-red-500/8 border border-red-500/15 p-1.5 text-center">
                      <p className="text-[9px] text-zinc-500">{n}</p>
                      <p className="text-[11px] font-black text-red-400">{p}</p>
                    </div>
                  ))}
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-px bg-zinc-800" />
                  <span className="text-[9px] text-zinc-600 font-mono">200 pts →</span>
                  <div className="flex-1 h-px bg-zinc-800" />
                </div>
                <div className="flex gap-1.5">
                  <div className="flex-1 rounded-lg bg-green-500/8 border border-green-500/20 p-1.5 text-center">
                    <p className="text-[9px] text-zinc-400">Player E</p>
                    <p className="text-[14px] font-black text-green-400">+200</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl bg-zinc-900 border border-zinc-800 overflow-hidden mb-3">
              <div className="px-3 py-2 border-b border-zinc-800 flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">3 Winners</span>
                <span className="text-[10px] font-mono text-zinc-600">each loser pays 3 × 50</span>
              </div>
              <div className="p-3 space-y-2">
                <div className="flex gap-1.5">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-px bg-zinc-800" />
                  <span className="text-[9px] text-zinc-600 font-mono">each winner gets 2 × 50</span>
                  <div className="flex-1 h-px bg-zinc-800" />
                </div>
                <div className="flex gap-1.5">
                  {['Player C', 'Player D', 'Player E'].map(n => (
                    <div key={n} className="flex-1 rounded-lg bg-green-500/8 border border-green-500/20 p-1.5 text-center">
                      <p className="text-[9px] text-zinc-400">{n}</p>
                      <p className="text-[11px] font-black text-green-400">+100</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="rounded-xl bg-zinc-900 border border-zinc-800 overflow-hidden">
              <div className="px-3 py-2 border-b border-zinc-800 flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">0 Winners</span>
                <span className="text-[10px] font-mono text-zinc-600">nobody went 4-for-4</span>
              </div>
              <div className="p-3 space-y-2">
                <div className="flex gap-1.5">
                  {['You', 'Player B', 'Player C', 'Player D', 'Player E'].map(n => (
                    <div key={n} className="flex-1 rounded-lg border border-zinc-800 p-1.5 text-center">
                      <p className="text-[9px] text-zinc-600">{n}</p>
                      <p className="text-[11px] font-black text-zinc-500">0</p>
                    </div>
                  ))}
                </div>
                <p className="text-center text-[10px] text-zinc-600 pt-1">No points change — the round is a wash.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-4 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[11px] font-black text-green-500 uppercase tracking-widest">Playoffs</p>
            </div>
              ...
              {[
                ...
                <div key={r.round} className={`flex items-center gap-3 px-3 py-2 ${i < 3 ? 'border-b border-zinc-800' : ''}`}>
                  <div className="w-[90px] flex-shrink-0">
                    <p className="text-[11px] text-zinc-300">{r.round}</p>
                    <p className="text-[9px] text-zinc-600">{r.picks} pick{r.picks !== 1 ? 's' : ''}</p>
                  </div>
                  <div className="flex-1 flex items-center gap-2">
                    <div className="flex-1 h-1.5 bg-zinc-800 rounded-full overflow-hidden">
                      <div className={`h-full bg-green-500 rounded-full ${r.barW}`} />
                    </div>
                    <span className="text-[11px] font-black font-mono text-green-400 w-6 text-right">+{r.cushion}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-[12px] font-black uppercase tracking-widest text-white">Over / Under (Playoffs Only)</p>
            </div>
            <p className="text-[12px] text-zinc-400 leading-relaxed mb-3">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
              <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-3">Wild Card · Total Line 47.5 · Cushion +10</p>
              <div className="flex gap-2">
                <div className="flex-1 rounded-lg border border-zinc-800 p-2.5 text-center">
                  <p className="text-[12px] font-black text-white uppercase mb-1">OVER</p>
                  <p className="text-[10px] font-mono text-zinc-500">Win if combined &gt;</p>
                  <p className="text-[15px] font-black font-mono text-green-400">37.5</p>
                  <p className="text-[9px] text-zinc-700 mt-0.5">47.5 – 10</p>
                </div>
                <div className="flex-1 rounded-lg border border-zinc-800 p-2.5 text-center">
                  <p className="text-[12px] font-black text-white uppercase mb-1">UNDER</p>
                  <p className="text-[10px] font-mono text-zinc-500">Win if combined &lt;</p>
                  <p className="text-[15px] font-black font-mono text-green-400">57.5</p>
                  <p className="text-[9px] text-zinc-700 mt-0.5">47.5 + 10</p>
                </div>
              </div>
            </div>
