...
export const SEASON_WEEKS: SeasonWeek[] = [
  ...
  { week: 2, name: 'Play-In',      startDate: '2026-04-14', endDate: '2026-04-17', placeholderCount: 4  },
  { week: 3, name: 'First Round',  startDate: '2026-04-18', endDate: '2026-04-28', placeholderCount: 8  },
